	...
	$.fn.extend({ 
		zAccordion: function(options) {
			...
			/* One of three is defined */
				...
				options.slideWidth = options.width - ((this.children().length - 1) * options.tabWidth);
			}
			else if ((options.width == undefined) && (options.slideWidth != undefined) && (options.tabWidth == undefined)) {
				options.width = defaults.width;
				options.tabWidth = (defaults.width - options.slideWidth) / (this.children().length - 1);
			}
			else if ((options.width == undefined) && (options.slideWidth == undefined) && (options.tabWidth != undefined)) {
				options.width = defaults.width;
				options.slideWidth  = options.width - ((this.children().length - 1) * options.tabWidth);
			...
			/* Two of three are defined */
				...
				options.tabWidth = (options.width - options.slideWidth) / (this.children().length - 1);
			}
			else if ((options.width != undefined) && (options.slideWidth == undefined) && (options.tabWidth != undefined)) {
				options.slideWidth = options.width - ((this.children().length - 1) * options.tabWidth);
			}
			else if ((options.width == undefined) && (options.slideWidth != undefined) && (options.tabWidth != undefined)) {
				options.width = ((this.children().length - 1) * options.tabWidth) + options.slideWidth;
			}
			...
			this.click = function(num) {
				...
				num++;
				if ((num > $(this).children().length) || (num < 1)) {
					num = 1;
				}
