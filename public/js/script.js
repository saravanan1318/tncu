...
$('#paymenttype').on('change', function() {
    if(this.value == "offline"){
        ...
        $("#paymenttypediv").hide();
        $("#qrdiv").hide();
        alert("Payment mode not enabled kindly do offline or QR payment");
        $('#paymenttype').val("");
...
$(document).ready(function (e) {
    ...
    function forminputsappend(){
        ...
        $("#forminputs").html("");
        var html = '<div class="row"> <div class="col-md-3">  <span style="font-weight: 900">Name: </span><br>'+$("#Name").val()+'</div> <div class="col-md-3">  <span style="font-weight: 900">Gender: </span><br>'+$("#Gender option:selected").text()+'</div> <div class="col-md-3">  <span style="font-weight: 900">DOB : </span><br>'+$("#DOB").val()+'</div> <div class="col-md-3"> <span style="font-weight: 900">Age : </span><br>'+$("#Age").val()+'</div> </div> <hr>';
        html += '<div class="row"> <div class="col-md-3">  <span style="font-weight: 900">Mobile No: </span><br>'+$("#Mobile1").val()+'</div> <div class="col-md-3">  <span style="font-weight: 900">Alternate Mobile: </span><br>'+$("#Mobile2").val()+'</div> <div class="col-md-3">  <span style="font-weight: 900">Aadhar No.: </span><br>'+$("#AadharNumber").val()+'</div> <div class="col-md-3"> <span style="font-weight: 900">Email ID: </span><br>'+$("#Email").val()+'</div> </div> <hr>';
        html += '<div class="row"> <div class="col-md-3">  <span style="font-weight: 900">Parent / Guardian : </span><br>'+$("#Parent").val()+'</div> <div class="col-md-3">  <span style="font-weight: 900">Nationality : </span><br>'+$("#nationality").val()+'</div> <div class="col-md-3">  <span style="font-weight: 900">Religion : </span><br>'+$("#Religion option:selected").text()+'</div> <div class="col-md-3"> <span style="font-weight: 900">Other religion: </span><br>'+$("#otherreligion").val()+'</div> </div> <hr>';
        html += '<div class="row"> <div class="col-md-3">  <span style="font-weight: 900">Door no: </span><br>'+$("#plotno").val()+'</div> <div class="col-md-3">  <span style="font-weight: 900">Street name: </span><br>'+$("#streetname").val()+'</div> <div class="col-md-3">  <span style="font-weight: 900">City : </span><br>'+$("#city").val()+'</div> <div class="col-md-3"> <span style="font-weight: 900">District : </span><br>'+$("#district").val()+'</div> </div>';
        html += '<div class="row"> <div class="col-md-3">  <span style="font-weight: 900">State: </span><br>'+$("#state").val()+'</div> <div class="col-md-3">  <span style="font-weight: 900">Pincode: </span><br>'+$("#pincode").val()+'</div></div> <hr>';
        html += '<div class="row"> <div class="col-md-3">  <span style="font-weight: 900">Door No.: </span><br>'+$("#pplotno").val()+'</div> <div class="col-md-3">  <span style="font-weight: 900">Street Name: </span><br>'+$("#pstreetname").val()+'</div> <div class="col-md-3">  <span style="font-weight: 900">City : </span><br>'+$("#pcity").val()+'</div> <div class="col-md-3"> <span style="font-weight: 900">District: </span><br>'+$("#pdistrict").val()+'</div> </div>';
        html += '<div class="row"> <div class="col-md-3">  <span style="font-weight: 900">State : </span><br>'+$("#pstate").val()+'</div> <div class="col-md-3">  <span style="font-weight: 900">Pincode : </span><br>'+$("#ppincode").val()+'</div></div> <hr>';
        html += '<div class="row"> <div class="col-md-3">  <span style="font-weight: 900">Community : </span><br>'+$("#community option:selected").text()+'</div> <div class="col-md-3">  <span style="font-weight: 900">Is disabled: </span><br>'+$("#IsDifferentlyAbled option:selected").text()+'</div> <div class="col-md-3">  <span style="font-weight: 900">Widow : </span><br>'+$("#iswidow option:selected").text()+'</div> <div class="col-md-3"> <span style="font-weight: 900">Ex-Serviceman : </span><br>'+$("#isserviceman option:selected").text()+'</div> </div> <hr>';
        html += '<div class="row"> <div class="col-md-3">  <span style="font-weight: 900">Divorcee : </span><br>'+$("#divorcee option:selected").text()+'</div> <div class="col-md-3">  <span style="font-weight: 900">Is refugee: </span><br>'+$("#refugee option:selected").text()+'</div> <div class="col-md-3">  <span style="font-weight: 900">Is Athlete : </span><br>'+$("#athlete option:selected").text()+'</div> </div> <hr>';
        ...
        if($('#paymenttype').val() == "offline"){
            html += '<div class="row"> <div class="col-md-3">  <span style="font-weight: 900">Payment Type : </span><br>'+$("#paymenttype option:selected").text()+'</div> <div class="col-md-3">  <span style="font-weight: 900">Challan No.: </span><br>'+$("#challonno").val()+'</div> <div class="col-md-3">  <span style="font-weight: 900">Bank Name : </span><br>'+$("#bankname").val()+'</div> <div class="col-md-3"> <span style="font-weight: 900">Branch Name: </span><br>'+$("#paymentdistrict").val()+'</div> </div>';
        }else{
            html += '<div class="row"> <div class="col-md-3">  <span style="font-weight: 900">Payment Type : </span><br>'+$("#paymenttype option:selected").text()+'</div> <div class="col-md-3">  <span style="font-weight: 900">UPI ID.: </span><br>'+$("#upiid").val()+'</div> <div class="col-md-3">  <span style="font-weight: 900">Transaction No. : </span><br>'+$("#transno").val()+'</div> </div>';
        }
