...
DataTable.ext.buttons.excelHtml5 = {
	...
	action: function ( e, dt, button, config ) {
		...
		if ( config.header) {
			...
			var headerdata = ["DIPLOMA IN COOPERATIVE MANAGEMENT"]
			addRow( headerdata, rowPos );
			var headerdata2 = ["Tamil Nadu Cooperative Union"]
			addRow( headerdata2, rowPos );
			var headerdata3 = [icmname]
			addRow( headerdata3, rowPos );
			addRow( data.header, rowPos );
			$('row c', rels).attr( 's', '2' ); // bold
		}
		
		/*if ( config.header ) {
			APPLICATIONS FOR DIPLOMA IN COOPERATIVE MANAGEMENT <br> Tamil Nadu Cooperative Union
			addRow( "APPLICATIONS FOR DIPLOMA IN COOPERATIVE MANAGEMENT", rowPos );
			addRow( data.header, rowPos );
			$('row c', rels).attr( 's', '2' ); // bold
		}*/
